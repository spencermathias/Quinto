shared = {
	cardDes: {products:[
		{name:'wheat',      value:100},
		{name:'rye',        value:70},
		{name:'corn',       value:75},
		{name:'barley',     value:85},
		{name:'flax',       value:40},
		{name:'hay',        value:50},
		{name:'oats',       value:60},
		{name:'soybeans',   value:55},
		{name:'coffee',     value:80},
		{name:'sugar',      value:65},
		{name:'oranges',    value:50},
		{name:'coco',       value:80},
		{name:'apples',     value:30},
		{name:'lemons',     value:20},
		{name:'grapes',     value:35},
		{name:'kewi',       value:45},
		{name:'wattermelon',value:25},
		{name:'cantalope',  value:40},
		{name:'strawberies',value:35},
		{name:'rasburies',  value:15},
		{name:'blueburies', value:10}],
	...
	validTilesToPlay: function(playerTiles, submittedBoardState, currentBoardState, allTiles) {
	...
	ensureSubmittedIsPhysicallyPossible: function(playerTiles, submittedBoardState, boardState, allTiles){
	...
	boardIsCorrectSize: function(submittedBoardState, boardState){
		correctSize = true;
