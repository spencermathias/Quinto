...
//import external js files (equivalent to the <script> tags in html
/*const fs = require('fs');
fs.readFile('./htmlCribbage/js/Deck.js', 'utf-8', (err, data) => {
  if(err) { throw err; }
  console.log('data: ', data);
});*/

//var Deck = require('./GameHelperFunctions/Deck.js');//shared deck class
var shared = require('./htmlCribbage/js/shared.js'); //get shared functions
